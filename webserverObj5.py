# Objective 5 is to make a page to delete a restaurant from DB 
        ...
        try:
            ...
            if self.path.endswith("/restaurants"):
                ...
                for restaurant in restaurants:
                    ...
                    output += "<a href ='/restaurants/%s/edit' >Edit </a> " % restaurant.rid
                    output += "</br>"
                    # Objective 5 -- Replace Delete href
                    output += "<a href ='/restaurants/%s/delete'> Delete </a>" % restaurant.rid
                    output += "</br></br></br>"
